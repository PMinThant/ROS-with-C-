...
"""autogenerated by genpy from action_pmt/demoActionResult.msg. Do not edit."""
import codecs
import sys
...
class demoActionResult(genpy.Message):
  ...
  _type = "action_pmt/demoActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','action_pmt/demoResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = action_pmt.msg.demoResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = action_pmt.msg.demoResult()
